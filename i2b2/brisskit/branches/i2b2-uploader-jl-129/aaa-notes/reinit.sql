...
/* reinitialization sql for a project with id "Biomed2" 
   NB: Will delete everything from PM where domain_id = 'BRISSKIT' */

drop schema Biomed2 cascade ;
drop user Biomed2 ;
...
set schema 'i2b2hive';
delete from i2b2hive.crc_db_lookup where c_project_path = '/Biomed2/' ;
delete from i2b2hive.ONT_DB_LOOKUP where c_project_path = 'Biomed2/' ;
delete from i2b2hive.WORK_DB_LOOKUP where c_project_path = 'Biomed2/' ;
delete from i2b2hive.IM_DB_LOOKUP where c_project_path = 'Biomed2/' ;

set schema 'i2b2pm';
delete from i2b2pm.PM_HIVE_DATA where domain_id = 'BRISSKIT' ;
DELETE FROM i2b2pm.PM_PROJECT_DATA where PROJECT_ID = 'Biomed2' ;
delete from i2b2pm.PM_PROJECT_USER_ROLES where PROJECT_ID = 'Biomed2' ;
